<template>
    <section>
        <div id="comic-series-list">
            ...
            L'attributo :info restituirà un oggetto diverso a seconda del punto in cui è il v-for  -->
            <Comiccard 
...
export default {
  ...
  data() {
      return {
        //   struttura dati che contiene le info necessarie per stampare le comiccard 
          comicSeries: [
              {
